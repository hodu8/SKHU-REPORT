...
(3)	반복문을 돌면서 1부터 5까지의 후보 중에 원하는 후보의 번호를 입력하도록 한다. 
사용자가 0을 입력하면 반복을 중단한다. 1~5사이가 아닌 다른 수를 입력하면 1~5사이의 값을 입력하도록 안내하고, 종료를 원하면 0을 입력하라고 안내한다.
...
printf("총 투표수 = %d\n",nov);
printf("각 후보별 득표 수 1. %d표 2. %d표 3. %d표 4. %d표 5. %d표\n",cand[0],cand[1],cand[2],cand[3],cand[4]);
return 0;
}